  ...
  head: () => ({
    meta: [
      ...
      { title: "Mitra — Care is better together." },
      {
        name: "description",
        content:
          "Mitra helps families and caregivers coordinate daily care with shared plans, gentle reminders and one calm place for everything.",
      },
      ...
      { property: "og:title", content: "Mitra — Care is better together." },
      {
        ...
        content: "A calm, shared home for everyday caregiving.",
      },
