...
export const Route = createFileRoute("/family/matches")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Caregivers suggested for your care request, with languages, skills and distance.",
      },
    ...
    >
      <SoftCard tone="sky">
        ...
        <p className="mt-2 text-sm opacity-90">
          We look at languages, skills, distance and availability. You always choose — Mitra only
          suggests.
        </p>
      </SoftCard>
